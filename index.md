...
instructor: ["Lieke de Boer", "Mateusz Kuzak", "Francesco Nattino"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Dafne van Kuppevelt", "Djura Smits", "Hanno Spreeuw"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
eventbrite: "178760446307" # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
